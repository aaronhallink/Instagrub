...
<div id="wrap">
	...
	<div id="search_box">
		<form name="post_msg" method="post">
			...
			<img src="images/search_unpressed.png" id="searchImage" onclick="recipeSearch()" onmousedown="changeImageSearch()"  onmouseup="revertImageSearch()" onclick="recipeSearch()" width="200px"/>
	</div>
</div>
</body>
</html>